...
strings.signIn = {
  "already_connected_meteor_dev_account":
    "This Meteor Developer account is already associated with an existing account.",
...
strings.app = {
  ...
  "config_connect_code": "Connect using one of the following methods.",
...
strings.emails = {
  "reset_password_subject": "Reset your passsword"
};
