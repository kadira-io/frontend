/**
 * Backup the orignal method
 * @type {Function}
 */
var orginalUpdateOrCreate = Accounts.updateOrCreateUserFromExternalService;

/**
 * Set the new update or create function
 * @param  {String} serviceName Current service the user is authenticating with
 * @param  {Object} serviceData Data returned by the service when token exchange
 *                              is complete
 * @return {Boolean}            This result is proxied from the
 *                              orginalUpdateOrCreate
 */
Accounts.updateOrCreateUserFromExternalService = function(serviceName, serviceData) {
  ...
  return orginalUpdateOrCreate.apply(this, arguments);
};
